...
- `repos/hashserver/` — hashserver HTTP API, compression protocol, endpoint behaviour
- `repos/seamless-transformer/` — worker internals, `seamless-upload`, `seamless-download`
