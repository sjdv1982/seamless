...
SYMBOLS = {
    ...
    'decimal_ext': ('bytes', 'kilobytes', 'megabytes', 'gigabytes', 'terabytes', 'petabytes'),
    'memory'     : ('bytes', 'KB', 'MB', 'GB', 'TB'),
    'memory2'    : ('B', 'K', 'M', 'G', 'T'),
    'binary'     : ('B', 'KiB', 'MiB', 'GiB', 'TiB', 'PiB'),
    'binary2'    : ('bytes', 'KiB', 'MiB', 'GiB', 'TiB', 'PiB'),
    'binary_ext' : ('bytes', 'kibibytes', 'mebibytes', 'gibibytes', 'tebibytes', 'pebibytes'),
}

def bytes2human(n, format='%(value).1f %(symbol)s', symbols='decimal'):
    """
