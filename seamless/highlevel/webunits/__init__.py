...
def _add_webunit(ctx, webunit_dict, **params):
...
def _init():
    ...
    for yaml_file in yaml_files:
        ...
        webunit_dict["@name"] = name
        help = webunit_dict.pop("help", name)
        func_impl = functools.partial(_add_webunit, webunit_dict=webunit_dict)
