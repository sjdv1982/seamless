...
from seamless.pandeval.core.computation.engines import _engines
from seamless.pandeval.core.computation.scope import _ensure_scope
...
def _check_engine(engine):
    ...
    """
    from seamless.pandeval.core.computation.check import _NUMEXPR_INSTALLED
...
def _check_parser(parser):
    ...
    """
    from seamless.pandeval.core.computation.expr import _parsers
...
def _check_for_locals(expr, stack_level, parser):
    from seamless.pandeval.core.computation.expr import tokenize_string
...
def eval(expr, parser='pandas', engine=None, truediv=True,
         ...
         target=None, inplace=False, align_result=False, str_as_bytes=True):
    ...
    inplace : bool, default False
        ...
        the mutation.
    align_result : bool, default False
    ...
    more details.
    """
    from seamless.pandeval.core.computation.expr import Expr
