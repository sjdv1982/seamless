...
# texture_coords
texture_coords =  vertices[:,6:8]
triangle_texture_coords = texture_coords[indices.flatten()]
...
PINS.texture_coords.set(texture_coords)
PINS.triangle_texture_coords.set(triangle_texture_coords)
