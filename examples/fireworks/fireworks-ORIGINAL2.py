...
#url = "https://i1.rgstatic.net/ii/profile.image/AS%3A279229301313544@1443584861381_l/Isaure_Debeauchene.png"
#im = Image.open(urlopen(url))
#im = Image.open("Isaure_Debeauchene.png")
...
void main () {
    ...
    {
        gl_Position.xyz = vec3(0.5, 0.5, 0.5);
