...
from seamless.workflow.core import context, cell, macro


mod_init = """
from absmodule.mod3 import testvalue
"""

mod1 = """
from absmodule import testvalue
def func():
    return testvalue
"""

mod2 = """
from absmodule.mod1 import func
"""
...
package = {
    "__name__": "absmodule",  # for internal absolute imports
    "__init__": {
        "language": "python",
        "code": mod_init,
        "dependencies": [".mod3"],
