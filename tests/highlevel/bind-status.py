...
ctx.compute()
print("Graph is written to /tmp/graph.json and accessible as http://localhost:5813/ctx/graph")
print("Status is written to /tmp/status.json and accessible as http://localhost:5813/ctx/status")
sleep(10)
print("***Initial state***")
sleep(1)
report()
