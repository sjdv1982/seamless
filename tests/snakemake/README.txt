...
The Seamless graph can be run interactively using "ipython3 -i run-snakegraph-interactive.py". This will create a live web page that constantly shows the progress. 
