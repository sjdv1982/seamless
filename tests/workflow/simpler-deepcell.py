...
ctx.compute()
print(
    "TRANSFORMER INPUT EXCEPTION", ctx.transform.inp.exception
)  # jsonschema.exceptions.ValidationError: 100 is not of type 'string'
...
print(
    ctx.transform._get_tf().inp.auth.value
)  #  As of Seamless 0.10, this gives {'b': 100}
