...
- Destroy (see 0.1), for the sake of macro re-evaluation
...
Then:
   ...
   - Dynamic connection layers: a special macro that has one or more contexts as input (among other inputs), and builds connections within/between those contexts.
